...
public class VenditoreServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(session.getAttribute("sessione") == "venditore") //controlla che la sessione attiva sia di tipo venditore
        {
            ...
            session.getAttribute("venditore");              //attributo venditore classe utente per leggere il nome e cognome
            request.getRequestDispatcher("/M3/home.jsp").forward(request, response);
